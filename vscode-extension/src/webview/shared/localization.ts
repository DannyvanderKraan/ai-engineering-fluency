...
export interface WebviewLocalization {
	...
	'efficiency.combined.seriesCostPerKloc': string;
	'efficiency.combined.seriesTokensPerSession': string;
	'efficiency.combined.seriesTurnsPerSession': string;
	'efficiency.combined.seriesActiveMinutes': string;
	'efficiency.combined.seriesRetryRate': string;
