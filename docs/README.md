...
| [features/EFFICIENCY-COMBINED-FILTERS.md](features/EFFICIENCY-COMBINED-FILTERS.md) | Combined tab — model vendor / model / editor filters, and how per-model values are attributed |
